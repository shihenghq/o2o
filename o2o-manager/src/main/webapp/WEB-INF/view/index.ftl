...
<head>
    ...
    <link href="/res/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<div id="wrapper">
  <#include "comm/navbar.ftl" >
  <#include "comm/right-top.ftl" >
  <#include "comm/right-navcation.ftl" >
</div>
...
<script src="/res/js/hplus.min.js?v=4.0.0"></script>
<script type="text/javascript" src="/res/js/contabs.min.js"></script>
